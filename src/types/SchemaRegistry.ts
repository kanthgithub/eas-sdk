...
export type ClaimTypeStruct = { key: BytesLike; dataType: BytesLike };

export type ClaimTypeStructOutput = [key: string, dataType: string] & {
  key: string;
  dataType: string;
};
...
export interface SchemaRegistryInterface extends Interface {
  ...
  encodeFunctionData(
    ...
    values: [string, ClaimTypeStruct[], AddressLike, boolean]
  ): string;
